...
# ACDS 20.1 711 win32 2025.02.26.12:45:36
...
# ----------------------------------------
# If pll_altera is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_altera.vho"
fi
